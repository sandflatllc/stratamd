// Adapted from t3code packages/shared/src/usageFormat.ts at 4e7359b. MIT license: ../renderer/terminal/LICENSE-T3.
 ...
 * @module usageFormat
 */
import type { UsageResolution, UsageSummaryInput } from "../shared/usage";
const UsageDay = { make: (day: string) => day };
