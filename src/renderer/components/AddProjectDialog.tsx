...
import { folderCrumbs, joinPath, parentPath, parseGithubRepository, parseGitUrl, repositoryFolderName } from '../../core/project-source'
import { HistoryIcon, ArrowUpIcon, FolderIcon, GitBranchIcon, GlobeIcon, PlusIcon } from '../icons/lucide'
...
export function AddProjectDialog({ engine, onClose, onAdded }: { engine: EngineView; onClose(): void; onAdded?(id: string): void }) {
  ...
  if (importingHistory) return <ImportDialog engine={engine} onClose={onClose} />
