...
window.Proposals = (() => {
  ...
  function importFlow(state){
    ...
    if(state==='confirm'){body='<div class="proposal-stack"><h3>2 conversations across 1 project</h3><p>All available history for each selected folder will be imported. Source history stays where it is. This is a one-time copy.</p>'+status('Cockpit project · /tmp/cockpit<br>Destination: Cockpit project')+'</div>';footer=button('Back','select')+button('Import conversations','progress',true);}
