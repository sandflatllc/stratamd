...
![An agent conversation in Strata with a rendered recommendation and comparison](docs/readme/images/agent-workspace.png)
...
![Leaving a comment on a specific passage in a Strata conversation](docs/readme/images/passage-comment.png)
...
![Visual feedback on a fictional project board inside Strata's browser](docs/readme/images/browser-annotation.png)
...
If you'd like to try it, give your agent this repository and ask it to help you get started. If you're not sure how something works, ask your agent. The [project documentation](docs/PRD.md) is there for it to read.
